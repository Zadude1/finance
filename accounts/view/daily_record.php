...
include "../php/numbers_to_words_convert.php";
?>

<?php
include "../php/daily_record/auth_daily_record.php";
?>
...
include "../php/daily_record/con_daily_record.php";
...
<?php
include "../php/daily_record/daily_record_table.php";
?>
...
<br>
 <!-- Display transaction table -->
    ...
    <?php
    include "../php/daily_record/daily_record_table_details.php";
?>
<div class="container">
...
<br><br>
    ...
    <input type="number" name="expenseid" id="expenseid" value="0">
<label for="expenseid">رقم مستند الصرف :</label>
...
<script src="../js/addrecscript.js"></script>

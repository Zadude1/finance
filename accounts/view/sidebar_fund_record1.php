...
<div id="page_wrapper">
    <div id="sidenav" class="sidenav">
        <div class="sidenav_header">
            ...
            <a href="sidebar_add_rec.php" class="sidenav_link">
            ...
            <?php if ($_SESSION['user']['user_type'] !== 'user2') { ?>
                ...
                <a href="sidebar_search_expense-copy.php" class="sidenav_link">
                    <i class='bx bx-calendar'></i>
                    <h3>' وصولات صرف يومية '</h3>
                </a>
                <a href="sidebar_search_expense_daily_records.php" class="sidenav_link">
                    <i class='bx bx-calendar'></i>
                    <h3>'اضافة وصل  دفع'</h3>
                </a>

...
if (isset($_POST['submitfinal'])) {
    ...
    $sql = "INSERT INTO daily_record  (number, money, data_in, type, date_ac, note, from_per, write_mo, id_u, name, id_col, id_s, e_number, e_date, type_of_receipt, year_r,adder_name,added_date) 

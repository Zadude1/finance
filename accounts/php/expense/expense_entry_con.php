...
if (isset($_POST['submitfinal'])) {
    ...
    $sql = "INSERT INTO expense  (number, money, data_in, type, date_ac, note, from_per, write_mo, id_u, name, id_col, id_s, d_number, d_date, type_of_receipt, year_r,adder_name,added_date) 
    VALUES ('$number','$totalPaidAmount', '$selected_date', '$paymentfor', '$field10', '$receivedInfo', '$receivedFrom', '$totalPaidAmountArabic', '{$_SESSION['user_id']}', '{$_SESSION['username']}', '$floatcollege', '$id_s', '$c_number', '$selected_cdate', '$field4', '$studyYear','{$_SESSION['username']}','$field10')";
    ...
    if(mysqli_query($conn, $sql)) {
        ...
        if (!empty($_SESSION['transactions'])) {
            ...
            foreach ($_SESSION['transactions'] as $transaction) {
                ...
                $sql_detal = "INSERT INTO expense_detal (type, money, number_acc, id_e) 
